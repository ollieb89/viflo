...
description: This system instruction is an official template from Google that has been evaluated by researchers to improve performance on agentic benchmarks where the model must adhere to a complex rulebook and interact with a user. It encourages the agent to act
---

# Strong Reasoner & Planner Agent (Official Google Template)

**Tags:** Agentic AI, Reasoning, Planning, Google, Official, Gemini, Agentic AI, Prompt Engineering, LLM, +2, Agentic AI, Debugging, Troubleshooting, +2, Agentic AI, Code Review, Quality Assurance, +2, Testing, MSW, API, Debugging, Git, Dependencies, VS Code, Monorepo, Productivity
