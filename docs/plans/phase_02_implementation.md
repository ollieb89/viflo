...
Instead of manually creating single-use documents, we will build an **`architectural-design` Skill**. This skill will encapuslate the Phase 2 methodology, providing templates and logic to bootstrap architectural planning for _any_ project.
...
### 2. Implement Phase 2 for _This_ Project
